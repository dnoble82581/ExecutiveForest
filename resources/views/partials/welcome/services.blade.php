<section id="welcome-services" class="mt-36">
    <header class="mb-16">
        <div class="flex justify-center">
            <h1 class="relative mb-5 inline-block text-center text-5xl font-thin text-primaryBlack underline-1">
                Our <span class="text-primaryGreen">Services</span></h1>
        </div>

        <p class="px-36 text-center text-lg text-primaryBlack">At Executive Forest we try to focus our creative energy. We believe that in
                                                      order to ensure that our customer always get the highest quality product we
                                                      need to limit our scope. Here you will see our three areas of
                                                      specialties.</p>
    </header>
